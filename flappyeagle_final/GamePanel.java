...
public class GamePanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        bird.update(g);
        if(FlappyBird.otherPlayers == true)
        {
            bird.updateOthers(g,FlappyBird.x,FlappyBird.y);
        }
        ...
        //    g.drawString("Waiting for other \nplayers...", FlappyBird.WIDTH/2-300, FlappyBird.HEIGHT/2+50);
       // }
    }
}
